...
## Type: QtColor
c.colors.tabs.pinned.even.bg = pink
...
## Type: QtColor
c.colors.tabs.pinned.odd.bg = pink
...
config.bind('xx', 'config-cycle tabs.show always never;; config-cycle')
